                ...
                <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#131a2a;border-radius:16px;border:1px solid #2a3550;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:24px 32px;color:#e5e9f2;">
                            <p style="margin:0 0 12px;font-size:18px;">Hello {!!$user!!},</p>
                            <p style="margin:0 0 16px;color:#9aa6bd;">Your registration is confirmed. Welcome to the Crazy-Systems support portal.</p>
                            <div style="background:#1c2538;border-radius:12px;padding:16px;margin-bottom:16px;border:1px solid #2a3550;">
                                <p style="margin:0 0 8px;"><strong>Registered Email:</strong> {!!$email_address!!}</p>
                                <p style="margin:0 0 8px;"><strong>Password:</strong> {!!$user_password!!}</p>
                                <p style="margin:0;"><strong>Portal:</strong> {!!$system_link!!}</p>
                            </div>
                            <p style="margin:0;color:#9aa6bd;">Thank you.</p>
